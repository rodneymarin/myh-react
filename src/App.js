    ...
    return (
        <div className="App">
            <header>
                ...
                <p>
                    He pensado en un número de 3 dígitos.
                    <br />
                    Debes adivinarlo en el mínimo número de intentos.
                    <br />
                    Muerto: cuando adivinas el número en la posición exacta que lo pensé.
                    <br />
